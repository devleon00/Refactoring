...
describe("Test de metodos de clase ExplorerService", () => {
    ...
    test("2) Probando 'getAmountOfExplorersByMission()'", () => {
        ...
        const result = ExplorerService.getAmountOfExplorersByMission(
            explorer,
            "node"
        );
    ...
    test("3) Probando 'getExplorersUsernamesByMission()'", () => {
        ...
        const result = ExplorerService.getExplorersUsernamesByMission(
            explorer,
            "node"
        );
    ...
    test("4) Probando 'getExplorersByStack()'", () => {
        const explorer = [
            {
                name: "Woopa2",
                githubUsername: "ajolonauta2",
        ...
        const result = ExplorerService.getExplorersByStack(
            explorer,
            "javascript"
        );
